      ...
      <div
        className={cn(
          ...
          variant === "floating" || variant === "inset"
            ...
            : "group-data-[collapsible=icon]:w-[--sidebar-width-icon] group-data-[side=left]:shadow-[2px_0_10px_rgba(0,0,0,0.07)] dark:group-data-[side=left]:shadow-[2px_0_10px_rgba(0,0,0,0.30)] group-data-[side=right]:shadow-[-2px_0_10px_rgba(0,0,0,0.07)] dark:group-data-[side=right]:shadow-[-2px_0_10px_rgba(0,0,0,0.30)]",
          className,
        )}
        {...props}
      >
...
const SidebarMenu = React.forwardRef<HTMLUListElement, React.ComponentProps<"ul">>(({ className, ...props }, ref) => (
  <ul ref={ref} data-sidebar="menu" className={cn("flex w-full min-w-0 flex-col gap-0.5 px-2", className)} {...props} />
));
